/* ═══════════════════════════════════════════
   MAGIC TWINKLE — subtle star/sparkle layer
   over the shop/store section background.
   Particles: four types —
     ✦ slow drift stars (base layer)
     ✦ sharp twinkle bursts (scale pulse)
     ✦ magic rune glyphs (rotating symbols)
     ✦ floating motes (tiny, fast)
═══════════════════════════════════════════ */
